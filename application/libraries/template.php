...
class template
{
    ...
    function Tampilan($template = null, $data = null)
    {
        ...
        $data['_header'] = $this->_ciTemplate->load->view('TemplateN/header', $data, TRUE);
        // $data['_sidebar'] = $this->_ciTemplate->load->view('Template/sidebar', $data, TRUE);
        $data['_footer'] = $this->_ciTemplate->load->view('TemplateN/footer', $data, TRUE);
        $data['_template'] = $this->_ciTemplate->load->view('TemplateN/template', $data);
    }
}